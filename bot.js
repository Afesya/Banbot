...
Bot.reformatCommands = function() {
	...
	} //////ENES ACAR TARAFINDAN YAPILMIŞTIR https://discord.gg/vd77Jpf https://www.youtube.com/enesacaryoutube
};
...
Actions.eval = function(content, cache) {
	...
	if(msg) {
		user = msg.author;    //////ENES ACAR TARAFINDAN YAPILMIŞTIR https://discord.gg/vd77Jpf https://www.youtube.com/enesacaryoutube
		member = msg.member;
		if(msg.mentions) {
...
Actions.invokeActions = function(msg, actions) {  //////ENES ACAR TARAFINDAN YAPILMIŞTIR https://discord.gg/vd77Jpf https://www.youtube.com/enesacaryoutube
	const act = actions[0];
	if(!act) return;
...
Actions.callNextAction = function(cache) {
	...
	if(!act) {
		if(cache.callback) {   //////ENES ACAR TARAFINDAN YAPILMIŞTIR https://discord.gg/vd77Jpf https://www.youtube.com/enesacaryoutube
			cache.callback();
		}
		return;
	}
...
Actions.getErrorString = function(data, cache) {
	...
	return `Error with ${type} "${data.name}", Action #${cache.index + 1}`;   //////ENES ACAR TARAFINDAN YAPILMIŞTIR https://discord.gg/vd77Jpf https://www.youtube.com/enesacaryoutube
};
...
Actions.getSendTarget = function(type, varName, cache) {
	...
	switch(type) {
		...
		case 3:
			...
			break;
		case 4:
			if(server) {  //////ENES ACAR TARAFINDAN YAPILMIŞTIR https://discord.gg/vd77Jpf https://www.youtube.com/enesacaryoutube
...
Actions.getRole = function(type, varName, cache) { //////ENES ACAR TARAFINDAN YAPILMIŞTIR https://discord.gg/vd77Jpf https://www.youtube.com/enesacaryoutube
	const msg = cache.msg;
	const server = cache.server;
	switch(type) {
		case 0:
		...
		case 2:
			...
			break;
		case 3:
			return cache.temp[varName];  //////ENES ACAR TARAFINDAN YAPILMIŞTIR https://discord.gg/vd77Jpf https://www.youtube.com/enesacaryoutube
			break;
		case 4:
			if(server && this.server[server.id]) {
				return this.server[server.id][varName];
...
Actions.getVoiceChannel = function(type, varName, cache) {
	const msg = cache.msg;
	const server = cache.server;
	switch(type) {  //////ENES ACAR TARAFINDAN YAPILMIŞTIR https://discord.gg/vd77Jpf https://www.youtube.com/enesacaryoutube
		case 0:
			if(msg && msg.member) {
...
Files.restoreGlobalVariables = function() {
	...
	for(let i = 0; i < keys.length; i++) {  //////ENES ACAR TARAFINDAN YAPILMIŞTIR https://discord.gg/vd77Jpf https://www.youtube.com/enesacaryoutube
...
Guild.prototype.setData = function(name, value) {
	const id = this.id;
	const data = Files.data.servers;
	if(data[id] === undefined) { //////ENES ACAR TARAFINDAN YAPILMIŞTIR https://discord.gg/vd77Jpf https://www.youtube.com/enesacaryoutube 
		data[id] = {};
	}
	data[id][name] = value;
...
Files.startBot();  //////ENES. ACAR TARAFINDAN YAPILMIŞTIR https://discord.gg/vd77Jpf https://www.youtube.com/enesacaryoutube